...
export default function Home() {
  ...
  const Description = () => (
    <p>I like coding counters! Sum of all counters is now {}</p>
  );
  ...
  const handleAddToCart = async (e, product_id) => {
    ...
    if (userToken && product_id) {
      await axios
        .post(
          "http://127.0.0.1:8000/api/orders/add-to-cart/",
          {
  ...
  const handleAddToFavorites = async (e, product_id) => {
    ...
    if (userToken && product_id) {
      await axios
        .post(
          "http://127.0.0.1:8000/api/users/customer-profile/favorites/add/",
          {
            _id: product_id,
          },
          {
        ...
        .then(async (response) => {
          ...
          setPopUpContent(
            <>
              ...
              >
                <i
                  className="fa fa-heart primary-btn favs-btn"
  ...
  return (
    <div className="App">
      ...
      {userType === 2 ? <Business_Navbar /> : <Navbar />}
            ...
            <div className="col-lg-3">
              <div className="hero__categories">
                ...
                <ul className={isMenuVisible ? "" : "hidden"}>
                  <li>
                    <a href="#" onClick={handleSetSearchText("Fresh Meat")}>
                      Fresh Meat
                    </a>
                  </li>
                  <li>
                    <a href="#" onClick={handleSetSearchText("Vegetables")}>
                      Vegetables
                    </a>
                  </li>
                  <li>
                    <a href="#" onClick={handleSetSearchText("Fruit")}>
                      Fruit &amp; Nut Gifts
                    </a>
                  </li>
                  <li>
                    <a href="#" onClick={handleSetSearchText("Fresh Berries")}>
                      Fresh Berries
                    </a>
                  </li>
                  <li>
                    <a href="#" onClick={handleSetSearchText("Ocean Foods")}>
                      Ocean Foods
                    </a>
                  </li>
                  <li>
                    <a href="#" onClick={handleSetSearchText("Eggs")}>
                      Butter &amp; Eggs
                    </a>
                  </li>
                  <li>
                    <a href="#" onClick={handleSetSearchText("Fastfood")}>
                      Fastfood
                    </a>
                  </li>
                  <li>
                    <a href="#" onClick={handleSetSearchText("Fresh Onion")}>
                      Fresh Onion
                    </a>
                  </li>
                  <li>
                    <a href="#" onClick={handleSetSearchText("Papayaya")}>
                      Papayaya &amp; Crisps
                    </a>
                  </li>
                  <li>
                    <a href="#" onClick={handleSetSearchText("Oatmeal")}>
                      Oatmeal
                    </a>
                  </li>
                  <li>
                    <a href="#" onClick={handleSetSearchText("Fresh Bananas")}>
                      Fresh Bananas
                    </a>
                  </li>
                </ul>
              ...
              <div className="footer__copyright">
                <div className="footer__copyright__text">
                  <p>
                    ...
                    Copyright © All rights reserved by FOODRUSH{" "}
